...
def parse_args():
    ...
    parser.add_argument('--input_w', default=896, type=int, help='image width')
    parser.add_argument('--input_h', default=416, type=int, help='image height')
    # loss
    parser.add_argument('--loss', default='BCEDiceLoss', choices=LOSS_NAMES, help='loss: ' +
                                                                                  ' | '.join(LOSS_NAMES) + ' (default: BCEDiceLoss)')

    # dataset
    parser.add_argument('--dataset', default='mgm', help='dataset name')
