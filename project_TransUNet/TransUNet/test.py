...
if __name__ == "__main__":
    ...
    dataset_config = {
        'mgs': {
            'Dataset': 'mgs_dataset',
            'volume_path': '../data/mgs/test_vol_h5',
            'list_dir': './lists/lists_mgs',
            'num_classes': 2,
            'z_spacing': 1,
        },
    }
    ...
    snapshot_path = snapshot_path + '_' + str(args.max_iterations)[
                                          0:2] + 'k' if args.max_iterations != 3000 else snapshot_path
