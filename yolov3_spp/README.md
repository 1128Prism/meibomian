...
# 转换后的文件保存目录
save_file_root = "/home/wz/my_project/my_yolo_voc"
...
```python
# 训练集的labels目录路径
train_annotation_dir = "/home/wz/my_project/my_yolo_voc/train/labels"
# 验证集的labels目录路径
val_annotation_dir = "/home/wz/my_project/my_yolo_voc/val/labels"
