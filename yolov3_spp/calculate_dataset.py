...
train_annotation_dir = "my_yolo_mg/train/labels"
val_annotation_dir = "my_yolo_mg/val/labels"
classes_label = "./data/mg_data_label.names"
...
def create_data_data(create_data_path, label_path, train_path, val_path, classes_info):
    # create voc_data.data file that record classes, train, valid and names info.
    # shutil.copyfile(label_path, "./data/mg_data_label.names")
    with open(create_data_path, "w") as w:
        ...
        w.write("names=data/mg_data_label.names" + "\n")        # 记录label.names文件路径


def change_and_create_cfg_file(classes_info, save_cfg_path="./cfg/voc_yolov3.cfg"):
...
def main():
    ...
    train_txt_path = "data/mg_train_data.txt"
    val_txt_path = "data/mg_val_data.txt"
    ...
    create_data_data("data/mg_data.data", classes_label, train_txt_path, val_txt_path, classes_info)
