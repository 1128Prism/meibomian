...
from data.dataset_mgs import mgs_dataset
...
parser.add_argument('--list_dir', type=str,
                    default='./lists/lists_mgs_c', help='list dir')
...
def inference(args, model, test_save_path=None):
    db_test = mgs_dataset(base_dir=args.volume_path, split="test_vol", list_dir=args.list_dir)
