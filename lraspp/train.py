...
def main(args):
    ...
    train_dataset = MGSegmentation(args.data_path,
                                    transforms=get_transform(train=True),
                                    txt_name="train.txt")

    # VOCdevkit -> VOC2012 -> ImageSets -> Segmentation -> val.txt
    val_dataset = MGSegmentation(args.data_path,
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="data/mgs", help="VOCdevkit root")
